...
pygame.display.set_caption('Bia don Tadhg')
...
pygame.mixer.music.load('sounds/budda.mp3')
...
miss_sound = pygame.mixer.Sound('sounds/bog.wav')
game_over_sound = pygame.mixer.Sound('sounds/circus.wav')
...
title_text = title_font.render("Bia don Tadhg!", True, "#3d5f9f", "black")
leid_text = title_font.render("Buail s do mhoilliú", True, "#3d5f9f", "black")
score_text = score_font.render(f"Scór: {score}", True, "#3d5f9f", "black")
lives_text = lives_font.render(f"Saolta: {lives}", True, "#3d5f9f", "black")
game_over_text = game_over_font.render("Cluiche Thart", True, "#3d5f9f", "black")
restart_game_text = restart_game_font.render("Buail 'p' le dul arís ...", True, "#3d5f9f", "black")
...
# load our images
aspen = pygame.image.load('images/tadhg1.jpg') 
food = pygame.image.load('images/hen_02.png')
